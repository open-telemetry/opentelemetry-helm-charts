...
* `charts/opentelemetry-collector/README.md` is generated by helm-docs, do not edit it directly.
  Edit `charts/opentelemetry-collector/README.md.gotmpl` for prose or the `# --` comments in
  `charts/opentelemetry-collector/values.yaml` for the values table, then run `make generate-docs`.
