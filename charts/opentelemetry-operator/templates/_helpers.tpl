...
*/}}
{{- define "autoGenerateCert.certPeriodDays" -}}
	{{- int (mul .Values.admissionWebhooks.autoGenerateCert.certPeriodYear 365) }}
{{- end }}
...
{{- $tmpperioddays := int (include "autoGenerateCert.certPeriodDays" .) }}
